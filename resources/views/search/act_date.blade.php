...
@section('content')
    <div class="box">
        <div class="overlay">
            <h2>البحث بتاريخ التصرف </h2>

            <!--start form -->
            <div class="search">
                <form action="{{ route('act_date') }}" method="POST" role="search">
                    {{ csrf_field() }}
                    <div class="input-group">
                        <input type="text" class="form-control myDate-picker" name="q" placeholder="yyyy-mmy-dd" autocomplete="off">
