...
@section('content')
    <div class="box">
        <div class="overlay">
            <h2>البحث بالرقم المدني للمتهم  </h2>

            <!--start form -->
            <div class="search">
                <form action="{{ route('accused_id') }}" method="POST" role="search">
                    {{ csrf_field() }}
                    <div class="input-group">
                        <input type="text" class="form-control" name="q" placeholder="ادخل الرقم المدني للمتهم !">
