...
@section('content')
    <div class="box">
        <div class="overlay">
            <h2>البحث باسم المجني عليه  </h2>

            <!--start form -->
            <div class="search">
                <form action="{{ route('victim') }}" method="POST" role="search">
                    {{ csrf_field() }}
                    <div class="input-group">
                        <input type="text" class="form-control" name="q" placeholder="ادخل اسم المجني عليه !">
